...
- ansible.docker.docker.docker_py_1_documentation
'''
...
from ansible_collections.ansible.docker.plugins.module_utils.docker.common import (
    AnsibleDockerClient,
    DifferenceTracker,
    DockerBaseClass,
    compare_generic,
...
try:
    ...
    from ansible_collections.ansible.docker.plugins.module_utils.docker.common import docker_version
